...
class StudentTransformationService:
    ...
    def get_students_transform(self):
        result = []
    ...
    def get_students_detailed_transform(self):
        result = []
        for student in Student.get_all(app.config.get("schedule_db_source")):
            student_data = student.__dict__()
    ...
    def get_student_by_id_detailed_transform(self, object_id: int):
    ...
    def create_student_transform(self, request: dict):
        dct = request
        try:
    ...
    def update_student_transform(self, object_id: int, request: dict):
        dct = request
