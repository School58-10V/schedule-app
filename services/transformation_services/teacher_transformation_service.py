...
class TeacherTransformationService:
    ...
    def get_teachers_transform(self):
        teachers = []
    ...
    def get_teacher_by_id_transform(self, object_id: int):
    ...
    def get_detailed_teachers_transform(self):
        teachers = []
        for i in Teacher.get_all(app.config.get("schedule_db_source")):
    ...
    def get_teacher_detailed_by_id(self, object_id: int):
        teacher = Teacher.get_by_id(object_id, app.config.get("schedule_db_source")).__dict__()
    ...
    def create_teacher_transform(self, request: dict):
        dct = request
    ...
    def update_teacher_transform(self, object_id: int, request: dict):
        teacher = Teacher.get_by_id(object_id, app.config.get("schedule_db_source")).__dict__()
        teacher['subject_id'] = [i.get_main_id() for i in TeachersForSubjects.
        ...
        return Teacher.get_by_id(object_id, app.config.get("schedule_db_source")).__dict__()

    def delete_teacher_transform(self, object_id: int):
