...
new_user = User(db_source=source.get_db_source(), login='login3', name='name2',
...
new_user.save()
new_user1 = User.get_by_login(login='login3', db_source=source.get_db_source())
print(new_user1.__dict__())
print(User.get_all(db_source=source.get_db_source()))
new_user1.delete()
print(new_user1)
# надо
