...
lesson_row_1 = LessonRow(db_source=fs, day_of_the_week='Friday', group_id=group_1.get_main_id(), subject_id=subject_1.get_main_id(), room_id=416, start_time=1230, end_time=1315, timetable_id=1).save()
lesson_row_2 = LessonRow(db_source=fs,day_of_the_week='Monday', group_id=group_2.get_main_id(), subject_id=subject_2.get_main_id(), room_id=413, start_time=1030, end_time=1115, timetable_id=1).save()
lesson_row_3 = LessonRow(db_source=fs, day_of_the_week='Monday', group_id=group_2.get_main_id(), subject_id=subject_2.get_main_id(), room_id=412, start_time=930, end_time=1015, timetable_id=1).save()
