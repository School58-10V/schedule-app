...
example_1 = {'start_time': 1015, 'end_time': 1100, 'day': datetime.date.today(), 'teacher_id': 5, 'group_id': 1, 'subject_id': 2, 'notes': 'Урок русского', 'state': True}
example_2 = {'start_time': 1100, 'end_time': 1145, 'day': datetime.date.today(), 'teacher_id': 7, 'group_id': 1, 'subject_id': 1, 'notes': 'Урок математики', 'state': True}
