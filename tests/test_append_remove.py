...
lesson_row = LessonRow(db_source=db_source, count_studying_hours=1, group_id=1, subject_id=1, room_id=1, start_time=1, end_time=1, timetable_id=1)
lesson_row.save()

# Создаем ряд уроков 1 и сохраняем его
lesson_row1 = LessonRow(db_source=db_source, count_studying_hours=2, group_id=2, subject_id=2, room_id=2, start_time=2, end_time=2, timetable_id=2)
lesson_row1.save()
