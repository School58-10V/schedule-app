...
class Student(AbstractModel):
    ...
    @classmethod
    def get_by_name(cls, name: str, db_source: AbstractSource) -> List[Student]:
        return [Student(**i, db_source=db_source) for i in db_source.get_by_query(cls._get_collection_name(),
                                                                            {'full_name': name})]
