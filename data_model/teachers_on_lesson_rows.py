...
class TeachersOnLessonRows(AbstractModel):
    ...
    @staticmethod
    def parse(file_location: str, db_source: db_source) -> List[(Optional[str], Optional[TeachersOnLessonRows])]:
        ...
        for i in lines:
            ...
            try:
                ...
                res.append(ParsedData(None, TeachersOnLessonRows(teacher_id=teacher_id, lesson_row_id=lesson_row_id, db_source=db_source)))
